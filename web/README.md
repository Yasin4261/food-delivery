...
- Working hours: chefs set a weekly schedule on the profile page (per-day
  windows, overnight allowed; no schedule = always open). Closed kitchens get
  a "closed now" badge and orders to them are rejected by the API.
